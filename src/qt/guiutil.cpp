...
{
    // HongyunCoin2: check prefix
    if(uri.scheme() != QString("HongyunCoin2"))
        return false;
...
{
    // Convert HongyunCoin2:// to HongyunCoin2:
    //
    //    Cannot handle this later, because bitcoin:// will cause Qt to see the part after // as host,
    //    which will lower-case it (and thus invalidate the address).
    if(uri.startsWith("HongyunCoin2://"))
    {
        uri.replace(0, 12, "HongyunCoin2:");
    }
    ...
    QMessageBox(parent)
{
    ...
    setWindowTitle(tr("HongyunCoin2-Qt"));
